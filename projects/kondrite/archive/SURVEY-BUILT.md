# SURVEY — what is built

The finished half of `../SURVEY-PLAN.md`, moved out of it on 24 September 2026
so the plan holds only what is still to do. Everything here is marked **DONE**
(or **FIXED**, or **SUPERSEDED**) and was built, tested and shipped.

It is cut out, not rewritten: every section is exactly as it stood in the plan,
in the plan's order, under its phase. Where the plan kept a live section between
two of these — 5.5, 5.8, the five long-term tracks, 6.1–6.6 — there is a gap
here and the live section is still there. Like the rest of this folder, this is
the record of what was decided and when. **Where it disagrees with the plan or
the code, they are right.**
...
**The screen is the shape of the device now.** Kondrite was laid out in a fixed
...
> my website. Remove the little button that says Ric's terminal for kondrite."*

Kondrite no longer loads `relay-return.js`. Every other project on the site gets
...
controls, video, audio, account — collapse to this at Kondrite's size, because
...
fourteen seconds — a decoy in a kondrite does not last its full life.
