...
console.log("");
console.log("KONDRITE — the Warrens of sector " + SEED);
...
if (problems.length) {
  console.log("");
  console.log("KONDRITE warrens checks FAILED");
  for (const p of problems) console.log("  · " + p);
  process.exit(1);
}
console.log("");
console.log("KONDRITE warrens checks passed");
