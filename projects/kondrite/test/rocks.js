...
/* KONDRITE — WHICH ROCKS MIGHT BE TOUCHING
   ─────────────────────────────────────────────────────────────────────────────
...
console.log("KONDRITE rock pair checks");
...
if (fails) {
  console.error("\nKONDRITE rock pair checks FAILED (" + fails + ")");
  process.exit(1);
}
console.log("KONDRITE rock pair checks passed");
