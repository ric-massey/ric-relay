...
/* CROSSFIRE — THE BIOMES OF A SECTOR
   ─────────────────────────────────────────────────────────────────────────────
...
console.log("");
console.log("CROSSFIRE — the biomes of sector " + SEED);
...
if (problems.length) {
  console.log("");
  console.log("CROSSFIRE biome checks FAILED");
  for (const p of problems) console.log("  · " + p);
  process.exit(1);
}
console.log("");
console.log("CROSSFIRE biome checks passed");
