...
separate job with its own landmines. This file keeps saying CROSSFIRE because
...
| `index.html` (the door) | `btnAcctGuest` (956) comes off the panel, and `crossfire.account.guest` (27060) stops being written |
